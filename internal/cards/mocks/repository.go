...
func (m *MockRepository) List(listID int) ([]models.Card, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) List(listID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockRepository)(nil).List), listID)
}
